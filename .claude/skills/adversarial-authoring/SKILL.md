...
license: MIT
compatibility: Requires Claude Code subagents named adversarial-author and adversarial-reviewer (in .claude/agents/), invoked via the Agent tool.
---
...
Use these hard-coded Claude Code subagents (defined in `.claude/agents/`, invoked via the Agent tool with `subagent_type`):
