...
description: Authors artifacts for adversarial-authoring (the drafting half of the model council). Invoked by the adversarial-authoring skill via the Agent tool.
