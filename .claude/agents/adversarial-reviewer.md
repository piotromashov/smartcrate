...
description: Reviews and challenges adversarial-authoring drafts (the skeptic half of the model council). Invoked by the adversarial-authoring skill via the Agent tool.
